...
describe("shorthand", () => {
  ...
  it("signature", () => {
    ...
    const signatureString =
      "SIG_K1_JwxtqesXpPdaZB9fdoVyzmbWkd8tuX742EQfnQNexTBfqryt2nn9PomT5xwsVnUB4m7KqTgTBQKYf2FTYbhkB5c7Kk9EsH";
...
function assertSerializer(
  type,
  value,
  fromObjectResult = null,
  toObjectResult = fromObjectResult
) {
