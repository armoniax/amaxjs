...
import type { Wallet } from '@amax/amaxwallet-adapter-react-hooks';
import React, { useCallback, useEffect, useMemo, useRef, useState } from 'react';
import type { FC, PropsWithChildren } from 'react';
import { AdapterState } from '@amax/abstract-adapter';
            ...
            >
                <div className="adapter-modal-wrapper">
                    <div className="adapter-modal-header">
                        ...
                        <div className="adapter-modal-title">Connect a wallet</div>
                    </div>
