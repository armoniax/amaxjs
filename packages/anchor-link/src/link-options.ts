import type {APIClient} from '@amax/amaxjs-core'
import type {ChainIdType} from '@amax/signing-request'
...
export interface LinkChainConfig {
    ...
    chainId: ChainIdType
    /**
     * URL to EOSIO node to communicate with (or a @amax/amaxjs-core APIClient instance).
     */
