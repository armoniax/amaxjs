...
/**
  ...
  @param {string} [pubkey_prefix = 'AM']
*/
function PublicKey(Q, pubkey_prefix = "AM") {
  if (typeof Q === "string") {
   ...
   * @arg {string} [pubkey_prefix = 'AM'] - public key prefix
   */
  function toString(pubkey_prefix = "AM") {
...
/**
  ...
  @param {string} [pubkey_prefix = 'AM']
*/
PublicKey.isValid = function (pubkey, pubkey_prefix = "AM") {
  try {
...
*/
PublicKey.fromString = function (public_key, pubkey_prefix = "AM") {
  try {
...
/**
    ...
    @return PublicKey
*/
PublicKey.fromStringOrThrow = function (public_key, pubkey_prefix = "AM") {
