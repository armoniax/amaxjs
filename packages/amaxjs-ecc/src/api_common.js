...
ecc.randomKey().then(privateKey => {
  ...
  console.log('Public Key:\t', ecc.privateToPublic(privateKey)) // AMAXkey...
})
    */
  ...
  /**
    ...
    */
  privateToPublic: (wif, pubkey_prefix = "AM") =>
    PrivateKey(wif).toPublic().toString(pubkey_prefix),

  /**
        @arg {pubkey} pubkey - like AMAXKey..
        @arg {string} [pubkey_prefix = 'AM']

        @return {boolean} valid

        @example ecc.isValidPublic(pubkey) === true
    */
  isValidPublic: (pubkey, pubkey_prefix = "AM") =>
  ...
  /**
        ...
        @arg {String|Buffer} signature (AMAXbase58sig.., Hex, Buffer)
